...
export type DateRangePickerElementProps<T extends FieldValues, TInputDate, TDate = TInputDate> = {
    name: Path<T>;
    ...
    return (
        <Controller
            ...
            render={({ field: { onChange, value, name }, fieldState: { error } }) => {
                return (
                    <RangePicker
                        className={styles['custom-default']}
                        style={style}
                        name={name}
                        disabled={disabled}
                        size={size}
                        ...
                        renderExtraFooter={() => (
                            <div className={styles['footer']}>
                                <button
                                    className={`p-btn ${styles['p-custom-btn']} p-b9-trans-btn`}
                                    onClick={handleCancel}
                                >
                                    Cancel
                                </button>
                                <button
                                    className={`p-btn ${styles['p-custom-btn']} p-primary-btn`}
                                    onClick={handleDone}
                                >
                                    Done
                                </button>
