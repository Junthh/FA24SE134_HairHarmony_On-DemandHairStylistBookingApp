...
const BoxCarouselStyled = styled(Box)({
  margin: '4px 0px',
  position: 'relative',
  '& .image-swiper-button-stylist-expert-prev': {
    position: 'absolute',
    top: '35%',
    left: '-35px',
    zIndex: 2,
  },
  '& .swiper-button-stylist-expert-disabled': {
    display: 'none',
  },
  '& .image-swiper-button-stylist-expert-next': {
    position: 'absolute',
    top: '35%',
    right: '-20px',
    zIndex: 2,
...
export default function TopStylistExpert({ stylist }) {
  ...
  return (
    <BoxCarouselStyled>
      <IconButton className="swiper-button image-swiper-button-stylist-expert-prev">
        <ICONS.IconCaretLeft />
      </IconButton>
      <IconButton className="swiper-button image-swiper-button-stylist-expert-next">
      ...
      </IconButton>
      {
        <>
          <SwiperStyled
            ...
            navigation={{
              nextEl: '.image-swiper-button-stylist-expert-next',
              prevEl: '.image-swiper-button-stylist-expert-prev',
              disabledClass: 'swiper-button-stylist-expert-disabled',
            }}
          >
            {stylist &&
