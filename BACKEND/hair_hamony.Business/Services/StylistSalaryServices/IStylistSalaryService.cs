...
namespace hair_hamony.Business.Services.StylistSalaryServices
{
    ...
    {
        Task<(IList<GetDetailStylistSalaryModel>, int)> GetAll(PagingParam<StylistSalaryEnum.StylistSalarySort> paginationModel, SearchStylistSalaryModel searchStylistSalaryModel);
